...
public class CucumberRunner {
    ...
    void testAll() {
        ...
        Results results = Runner.path("classpath:caller").tags(tagList).outputCucumberJson(true).parallel(0);
    ...
    void testParallel() {
        ...
        Results results = Runner.path("classpath:caller").tags(tagList).outputCucumberJson(true).parallel(count);
        generateReport(results.getReportDir());
    ...
    public static void generateReport(String karateOutputPath) {
        ...
        Configuration config = new Configuration(new File("target"), "Karate Base Project");
